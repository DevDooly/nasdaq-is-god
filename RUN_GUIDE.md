...
python3 main_api.py
```
- **Swagger UI**: [http://localhost:9000/docs](http://localhost:9000/docs) 접속 가능
...
- **포트 충돌**: 9000 포트가 이미 사용 중이라면 `main_api.py`의 `uvicorn.run(port=9000)`을 변경하세요.
- **Flutter 실행 불가**: `flutter build web` 후 `./run_web.sh`를 실행해 보세요.